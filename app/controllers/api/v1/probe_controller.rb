    ...
    class ProbeController < ApplicationController
      ...
      def moviments
        begin
          ...
          render status: :ok, json: {cod: 200, status: "OK", message: "Sonda movida com sucesso"}
        rescue
          render status: :bad_request, json: {cod: 400, status: "Bad Request", message: "Você se moveu para um local invalido, por favor resete seus movimentos"}
        end
      end
